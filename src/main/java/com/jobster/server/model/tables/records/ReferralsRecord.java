...
public class ReferralsRecord extends UpdatableRecordImpl<ReferralsRecord> implements Record8<Integer, Integer, Integer, Timestamp, Timestamp, Integer, Integer, String> {

    private static final long serialVersionUID = 2087795049;
     ...
     */
    @Override
    public Row8<Integer, Integer, Integer, Timestamp, Timestamp, Integer, Integer, String> fieldsRow() {
     ...
     */
    @Override
    public Row8<Integer, Integer, Integer, Timestamp, Timestamp, Integer, Integer, String> valuesRow() {
     ...
     */
    @Override
    public ReferralsRecord values(Integer value1, Integer value2, Integer value3, Timestamp value4, Timestamp value5, Integer value6, Integer value7, String value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ReferralsRecord(Integer idReferral, Integer idJobster, Integer idCandidate, Timestamp dateCreation, Timestamp dateAccepted, Integer rankPosition, Integer state, String code) {
        super(Referrals.REFERRALS);
