...
public class ReferralsRecord extends UpdatableRecordImpl<ReferralsRecord> implements Record10<Integer, Integer, Integer, Integer, Integer, String, Integer, String, Timestamp, Timestamp> {
    ...
    private static final long serialVersionUID = 719698697;
     ...
     */
    public ReferralsRecord(Integer idReferral, Integer idEndorser, Integer idCandidate, Integer score, Integer state, String code, Integer idOffer, String emailCandidate, Timestamp dateCreation, Timestamp dateAccepted) {
        super(Referrals.REFERRALS);
